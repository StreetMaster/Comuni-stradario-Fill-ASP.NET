    ...
    <form id="DemoFill" runat="server">
        <div style="border: groove; border-color: #336600; width: 482px;">
            ...
            <table border="0" cellpadding="2" cellspacing="2">
                ...
                <tr>
                    <td>Comune</td>
                    <td><asp:TextBox ID="txtComune" autocomplete="off" Width="400px" runat="server" /></td>
                </tr>
                <tr>
                    <td>Cap</td>
                    <td><asp:TextBox ID="txtCap" autocomplete="off" Width="50px" runat="server" /></td>
                </tr>
                <tr>
                    <td>Frazione</td>
                    <td><asp:TextBox ID="txtFrazione" autocomplete="off" Width="400px" runat="server" /></td>
                </tr>
                <tr>
                    <td>Indirizzo</td>
                    <td><asp:TextBox ID="txtIndirizzo" autocomplete="off" Width="400px" runat="server" /></td>
                </tr>
            </table>
        </div>
        <p>
